...
<title>Update Order | Burrito King Resturant</title>
					...
					<div class="col-md-8">
						<div class="form-floating">
							<input type="text" class="form-control" id="oid" name="oid"
								value="${param.oid}" readonly> <label for="uid">User
								ID</label>
						</div>
					</div>
					<div class="col-md-8">
						<div class="form-floating">
							...
							</select> <label for="dropdown">Select Option</label>
						</div>
					</div>

					<div class="col-md-8">
						<div class="form-floating">
							<input type="time" name="recievedTime"
								class="form-control form-control-lg" size="17"
								placeholder="Order Received Time"/> <label for="recievedTime">Order
								Received Time</label>
						</div>
					</div>
